  ...
  render() {
    return (
      React.createElement("div", null, 
        React.createElement(Header, {addJobButtonHandler:  this.toggleAddJobForm.bind(this) }), 
        React.createElement(AddJobForm, {saveButtonHandler:  this.jobSaved.bind(this), cancelButtonHandler:  this.toggleAddJobForm.bind(this), visibilityClassName:  this.state.addJobFormVisibility}), 
        React.createElement(SearchForm, {searchButtonHandler:  this.searchHandler.bind(this), visibilityClassName:  this.state.searchFormVisibility}), 
        React.createElement(JobsList, {ref: "jobslist", visibilityClassName:  this.state.jobsListVisibility})
      )
    );
  }
}
...
class AddJobForm extends React.Component {
  ...
  render() {
    return (
      React.createElement("div", {className:  this.props.visibilityClassName}, 
        React.createElement("form", {action: ""}, 
          React.createElement("div", null, 
            React.createElement("input", {id: "title", ref: "addTitleInput", onChange:  this.updateState.bind(this), value:  this.state.title, placeholder: "Title"})
          ), 
          React.createElement("div", null, 
            React.createElement("input", {id: "company", ref: "addCompanyInput", onChange:  this.updateState.bind(this), value:  this.state.company, placeholder: "Company"})
          ), 
          React.createElement("div", null, 
            React.createElement("input", {id: "link", ref: "addLinkInput", onChange:  this.updateState.bind(this), value:  this.state.link, placeholder: "Link"})
          ), 
          React.createElement("div", {className: "add-job-save-button"}, 
            React.createElement("button", {onClick:  this.save.bind(this) }, "Save"), "  ", 
            React.createElement("a", {href: "#", onClick:  this.props.cancelButtonHandler}, "Cancel")
          )
        )
      )
    );
...
class SearchForm extends React.Component {
  ...
  render() {
    return (
      React.createElement("div", {className:  this.props.visibilityClassName}, 
        React.createElement("form", {action: ""}, 
          React.createElement("input", {ref: "titleInput", onChange:  this.updateSearch.bind(this), type: "search", id: "search-title", placeholder: "Search by Title"}), 
          React.createElement("input", {ref: "companyInput", onChange:  this.updateSearch.bind(this), type: "search", id: "search-company", placeholder: "Search by Company"}), 
          "Sort by:", 
          React.createElement("select", {ref: "sortInput", onChange:  this.updateSearch.bind(this), id: "sort"}, 
...
class Job extends React.Component {
  ...
  render() {
    return (
      React.createElement("li", {className: "job", key:  this.state.id}, 
        React.createElement("h3", null, React.createElement("a", {href:  this.state.link},  this.state.title)), 
        React.createElement("p", null, "at ", React.createElement("strong", null,  this.state.company), ", posted at ",  this.state.createdAt), 
        React.createElement("button", {className: "delete", onClick:  this.deleteJob.bind(this, this.state.id) }, "Delete")
      )
    );
  }
}
...
class JobsList extends React.Component {
  ...
  render() {
    var jobs = this.state.jobs.map(job => 
      React.createElement(Job, {key:  job._id, id:  job._id, title:  job.title, company:  job.company, link:  job.link, createdAt:  job.createdAt, deleteJobHandler:  this.loadJobs.bind(this) })
    );

    return (
      React.createElement("section", {id: "jobs-container", className:  this.props.visibilityClassName}, 
        React.createElement("p", {className: this.state.activityIndicatorVisibility}, "Loading..."), 
        React.createElement("ul", null, 
           jobs 
        ), 
        React.createElement("button", {id: "load-more", className:  this.state.loadMoreButtonVisibility, onClick:  this.loadMore.bind(this) }, "Load More")
      )
    );
  }
}
...
class Header extends React.Component {
  render() {
    return (
      React.createElement("div", null, 
        React.createElement("h1", null, "Jobbed Out"), 
        React.createElement("div", {className: "add-job-button"}, 
          React.createElement("button", {id: "add-job", onClick:  this.props.addJobButtonHandler}, "Add a Job")
        )
      )
    );
  }
